            ...
            <div className="w-full md:w-1/2 h-full md:h-auto">
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div>
                            <slide.title />
                            <p className="mt-4 text-xs md:text-lg max-w-4xl">{slide.description}</p>
                                ...
                                {slide.type === 'main' ? (
                                    <div className="grid grid-cols-3 gap-x-2 md:flex md:gap-6 w-full justify-start">
                                        {slide.features.map((feature, i) => (
                                            <div key={i} className="flex flex-col items-center text-center gap-2 w-full md:w-40 flex-grow">
                                                {'icon' in feature && (
