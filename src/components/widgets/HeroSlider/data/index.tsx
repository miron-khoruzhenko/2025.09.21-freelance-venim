  ...
  // Слайд 1 (уникальный)
  {
    ...
    title: () => (
      <h1 className="text-2xl md:text-5xl font-extrabold leading-tight text-black">
        ...
        <span className="">Защищаем, прогнозируем,</span><br/>
    ...
    features: [
      { icon: '/images/1.Hero/award_icon.png', text: 'Выиграли <strong class="text-primary">98%<br/> из 10 000+</strong> дел' },
      { icon: '/images/1.Hero/agreement_icon.png', text: 'Стратегия защиты<br/><strong class="text-primary">активов</strong> и репутации' },
      { icon: '/images/1.Hero/team_icon.png', text: '<strong class="text-primary">Вернем до 70%</strong> нашей<br/>комиссии, если проиграем' }
    ],
