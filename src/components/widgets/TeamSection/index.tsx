...
function AnimatedStat({ stat }: { stat: Stat }) {
    ...
    if (inView && ref.current) {
      const controls = animate(0, stat.value, {
        ...
        onUpdate(value) {
          ...
          if (stat.value >= 1000) {
            formattedValue = new Intl.NumberFormat("ru-RU").format(
              Math.round(value),
            );
          }
  ...
  return (
    <div ref={inViewRef} className="text-center md:text-left">
      ...
      <p className="mt-2 text-sm text-gray-600 max-w-[200px] mx-auto md:mx-0">
        {stat.label}
      </p>
    </div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div>
            ...
            <p className="mt-6 text-gray-700">
              В нашей компании работают юристы с многолетним опытом. Множество
              выигранных дел и разнообразие практик - всё это сотрудники
              компании Venim.
            </p>
